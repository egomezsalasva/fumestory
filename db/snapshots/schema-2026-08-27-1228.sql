...
\restrict BJKVvOkY7HkAxDYPSUzceEGy8VRkbGodH1nmWAL2HaDNy4f9SpL7M6gvtt13ZGb
...
ALTER TABLE ONLY public.academy_progress FORCE ROW LEVEL SECURITY;
...
CREATE TABLE public.categories (
    ...
    parent_id integer,
    owner_id uuid,
    CONSTRAINT categories_kind_check CHECK ((kind = ANY (ARRAY['curated'::text, 'other'::text]))),
    CONSTRAINT categories_kind_owner_check CHECK ((((kind = 'curated'::text) AND (owner_id IS NULL)) OR ((kind = 'other'::text) AND (owner_id IS NOT NULL)))),
    CONSTRAINT categories_name_lowercase_check CHECK ((name = lower(name)))
);
...
CREATE TABLE public.compositions (
    ...
    brief text,
    CONSTRAINT compositions_brief_length_check CHECK (((brief IS NULL) OR (char_length(brief) <= 8000))),
    CONSTRAINT compositions_status_check CHECK ((status = ANY (ARRAY['active'::text, 'archived'::text]))),
...
CREATE TABLE public.formulas (
    ...
    mods text NOT NULL,
    comment text,
    CONSTRAINT formulas_comment_length_check CHECK (((comment IS NULL) OR (char_length(comment) <= 2000)))
);
...
CREATE TABLE public.notes (
    ...
    owner_id uuid,
    color text,
    CONSTRAINT notes_kind_owner_check CHECK ((((kind = 'curated'::text) AND (owner_id IS NULL) AND (color IS NOT NULL)) OR ((kind = 'other'::text) AND (owner_id IS NOT NULL)))),
    CONSTRAINT notes_name_lowercase_check CHECK ((name = lower(name)))
);
...
--
-- Name: offline_installs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.offline_installs (
    ...
    CONSTRAINT offline_installs_email_lower_check CHECK (((email IS NULL) OR (email = lower(email))))
);

ALTER TABLE ONLY public.offline_installs FORCE ROW LEVEL SECURITY;


--
-- Name: payg_codes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payg_codes (
    code text NOT NULL,
    email text NOT NULL,
    extras_materials integer DEFAULT 0 NOT NULL,
    extras_dilutions integer DEFAULT 0 NOT NULL,
    extras_compositions integer DEFAULT 0 NOT NULL,
    extras_mods integer DEFAULT 0 NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    redeemed_at timestamp with time zone,
    CONSTRAINT payg_codes_code_nonempty_check CHECK ((char_length(TRIM(BOTH FROM code)) >= 6)),
    CONSTRAINT payg_codes_email_lower_check CHECK ((email = lower(email))),
    CONSTRAINT payg_codes_extras_nonneg_check CHECK (((extras_materials >= 0) AND (extras_dilutions >= 0) AND (extras_compositions >= 0) AND (extras_mods >= 0))),
    CONSTRAINT payg_codes_extras_nonzero_check CHECK (((((extras_materials + extras_dilutions) + extras_compositions) + extras_mods) > 0))
);

ALTER TABLE ONLY public.payg_codes FORCE ROW LEVEL SECURITY;
...
CREATE TABLE public.raw_materials (
    ...
    cas_number text,
    CONSTRAINT raw_materials_cas_number_check CHECK (((cas_number IS NULL) OR (cas_number ~ '^\d{2,7}-\d{2}-\d$'::text))),
    CONSTRAINT raw_materials_nature_check CHECK (((material_nature IS NULL) OR (material_nature = ANY (ARRAY['Natural'::text, 'Synthetic'::text])))),
...
--
-- Name: scent_blind_test_results; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scent_blind_test_results_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scent_blind_test_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: scent_blind_test_results_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scent_blind_test_results_id_seq OWNED BY public.scent_blind_test_results.id;
...
CREATE TABLE public.user_settings (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    dismissed_ui jsonb DEFAULT '{}'::jsonb NOT NULL
);
...
--
-- Name: scent_blind_test_results id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scent_blind_test_results ALTER COLUMN id SET DEFAULT nextval('public.scent_blind_test_results_id_seq'::regclass);
...
--
-- Name: offline_installs offline_installs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.offline_installs
    ADD CONSTRAINT offline_installs_pkey PRIMARY KEY (install_id);


--
-- Name: payg_codes payg_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payg_codes
    ADD CONSTRAINT payg_codes_pkey PRIMARY KEY (code);
...
--
-- Name: scent_blind_test_results scent_blind_test_results_batch_dilution_uidx; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scent_blind_test_results
    ADD CONSTRAINT scent_blind_test_results_batch_dilution_uidx UNIQUE (batch_id, dilution_id);


--
-- Name: scent_blind_test_results scent_blind_test_results_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scent_blind_test_results
    ADD CONSTRAINT scent_blind_test_results_pkey PRIMARY KEY (id);
...
--
-- Name: categories_curated_name_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX categories_curated_name_uidx ON public.categories USING btree (name) WHERE (kind = 'curated'::text);


--
-- Name: categories_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX categories_kind_idx ON public.categories USING btree (kind);


--
-- Name: categories_other_owner_name_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX categories_other_owner_name_uidx ON public.categories USING btree (owner_id, name) WHERE (kind = 'other'::text);


--
-- Name: categories_owner_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX categories_owner_id_idx ON public.categories USING btree (owner_id);
...
--
-- Name: compositions_owner_label_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX compositions_owner_label_uidx ON public.compositions USING btree (owner_id, label);
...
--
-- Name: notes_curated_name_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX notes_curated_name_uidx ON public.notes USING btree (name) WHERE (kind = 'curated'::text);


--
-- Name: notes_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notes_kind_idx ON public.notes USING btree (kind);


--
-- Name: notes_other_owner_name_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX notes_other_owner_name_uidx ON public.notes USING btree (owner_id, name) WHERE (kind = 'other'::text);


--
-- Name: notes_owner_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notes_owner_id_idx ON public.notes USING btree (owner_id);


--
-- Name: offline_installs_email_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX offline_installs_email_idx ON public.offline_installs USING btree (email) WHERE (email IS NOT NULL);


--
-- Name: payg_codes_email_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payg_codes_email_idx ON public.payg_codes USING btree (email);


--
-- Name: raw_materials_owner_label_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX raw_materials_owner_label_uidx ON public.raw_materials USING btree (owner_id, label);
...
--
-- Name: scent_blind_test_results_batch_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scent_blind_test_results_batch_id_idx ON public.scent_blind_test_results USING btree (batch_id);


--
-- Name: scent_blind_test_results_owner_batch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scent_blind_test_results_owner_batch_idx ON public.scent_blind_test_results USING btree (owner_id, batch_id);


--
-- Name: scent_blind_test_results_owner_dilution_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX scent_blind_test_results_owner_dilution_idx ON public.scent_blind_test_results USING btree (owner_id, dilution_id);
...
ALTER TABLE ONLY public.academy_progress
    ADD CONSTRAINT academy_progress_user_id_fkey FOREIGN KEY (user_id) REFERENCES neon_auth."user"(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.categories
    ADD CONSTRAINT categories_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES neon_auth."user"(id);
...
ALTER TABLE ONLY public.notes
    ADD CONSTRAINT notes_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES neon_auth."user"(id);
...
--
-- Name: scent_blind_test_results scent_blind_test_results_dilution_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scent_blind_test_results
    ADD CONSTRAINT scent_blind_test_results_dilution_id_fkey FOREIGN KEY (dilution_id) REFERENCES public.dilutions(id) ON DELETE CASCADE;


--
-- Name: scent_blind_test_results scent_blind_test_results_owner_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scent_blind_test_results
    ADD CONSTRAINT scent_blind_test_results_owner_fkey FOREIGN KEY (owner_id) REFERENCES neon_auth."user"(id);
...
--
-- Name: academy_progress academy_progress_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY academy_progress_insert_own ON public.academy_progress FOR INSERT TO neondb_owner WITH CHECK ((user_id = (current_setting('app.current_user_id'::text, true))::uuid));


--
-- Name: academy_progress academy_progress_select_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY academy_progress_select_own ON public.academy_progress FOR SELECT TO neondb_owner USING ((user_id = (current_setting('app.current_user_id'::text, true))::uuid));


--
-- Name: academy_progress academy_progress_update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY academy_progress_update_own ON public.academy_progress FOR UPDATE TO neondb_owner USING ((user_id = (current_setting('app.current_user_id'::text, true))::uuid)) WITH CHECK ((user_id = (current_setting('app.current_user_id'::text, true))::uuid));
...
--
-- Name: categories categories_delete_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY categories_delete_own_other ON public.categories FOR DELETE TO neondb_owner USING (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));


--
-- Name: categories categories_insert_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY categories_insert_own_other ON public.categories FOR INSERT TO neondb_owner WITH CHECK (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));


--
-- Name: categories categories_select_curated_or_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY categories_select_curated_or_own ON public.categories FOR SELECT TO neondb_owner USING (((kind = 'curated'::text) OR ((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid))));


--
-- Name: categories categories_update_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY categories_update_own_other ON public.categories FOR UPDATE TO neondb_owner USING (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid))) WITH CHECK (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));
...
--
-- Name: notes notes_delete_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY notes_delete_own_other ON public.notes FOR DELETE TO neondb_owner USING (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));


--
-- Name: notes notes_insert_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY notes_insert_own_other ON public.notes FOR INSERT TO neondb_owner WITH CHECK (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));


--
-- Name: notes notes_select_curated_or_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY notes_select_curated_or_own ON public.notes FOR SELECT TO neondb_owner USING (((kind = 'curated'::text) OR ((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid))));


--
-- Name: notes notes_update_own_other; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY notes_update_own_other ON public.notes FOR UPDATE TO neondb_owner USING (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid))) WITH CHECK (((kind = 'other'::text) AND (owner_id = (current_setting('app.current_user_id'::text, true))::uuid)));


--
-- Name: offline_installs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.offline_installs ENABLE ROW LEVEL SECURITY;

--
-- Name: offline_installs offline_installs_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY offline_installs_all ON public.offline_installs TO neondb_owner USING (true) WITH CHECK (true);


--
-- Name: payg_codes; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.payg_codes ENABLE ROW LEVEL SECURITY;

--
-- Name: payg_codes payg_codes_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY payg_codes_all ON public.payg_codes TO neondb_owner USING (true) WITH CHECK (true);
...
--
-- Name: scent_blind_test_results; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.scent_blind_test_results ENABLE ROW LEVEL SECURITY;

--
-- Name: scent_blind_test_results scent_blind_test_results_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY scent_blind_test_results_delete_own ON public.scent_blind_test_results FOR DELETE TO neondb_owner USING ((owner_id = (current_setting('app.current_user_id'::text, true))::uuid));


--
-- Name: scent_blind_test_results scent_blind_test_results_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY scent_blind_test_results_insert_own ON public.scent_blind_test_results FOR INSERT TO neondb_owner WITH CHECK (((owner_id = (current_setting('app.current_user_id'::text, true))::uuid) AND (EXISTS ( SELECT 1
   FROM (public.dilutions d
     JOIN public.raw_materials rm ON ((rm.id = d.raw_material_id)))
  WHERE ((d.id = scent_blind_test_results.dilution_id) AND (rm.owner_id = (current_setting('app.current_user_id'::text, true))::uuid))))));


--
-- Name: scent_blind_test_results scent_blind_test_results_select_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY scent_blind_test_results_select_own ON public.scent_blind_test_results FOR SELECT TO neondb_owner USING ((owner_id = (current_setting('app.current_user_id'::text, true))::uuid));
...
\unrestrict BJKVvOkY7HkAxDYPSUzceEGy8VRkbGodH1nmWAL2HaDNy4f9SpL7M6gvtt13ZGb
