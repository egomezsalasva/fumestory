...
export const patchUserSettingsSchema = z
	.object({
		...
		academy_enabled: z.boolean().optional(),
	})
	.refine(
		(d) => {
			...
			if (d.academy_enabled !== undefined) return true;
...
export function parseUserSettingsJson(
	...
	if (typeof o.academy_enabled === "boolean") {
		out.academy_enabled = o.academy_enabled;
	}
...
export function effectiveUserSettings(
	...
	return {
		...
		academy_enabled: stored.academy_enabled !== false,
	};
}
...
export function mergeUserSettingsJson(
	...
	if (typeof patch.academy_enabled === "boolean") {
		merged.academy_enabled = patch.academy_enabled;
	}
	return merged;
}
